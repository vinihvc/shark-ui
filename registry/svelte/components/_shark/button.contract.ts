// Generated by scripts/generate-framework-registry.mts (743d50568ee7). Do not edit.
import { tv } from "tailwind-variants";

export const componentContract = {
  "description": "Button surface with visual variants and a stable loading state.",
  "name": "button",
  "parts": [
    {
      "element": "button",
