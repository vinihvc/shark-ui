...
const cssVars = {
  dark: {
    ...
    input: "color-mix(in srgb, var(--color-neutral-50) 15%, var(--background))",
    muted: "color-mix(in srgb, var(--color-neutral-50) 6%, var(--background))",
    "muted-foreground":
  ...
  light: {
    ...
    muted: "color-mix(in srgb, var(--color-neutral-950) 5%, var(--background))",
    "muted-foreground":
