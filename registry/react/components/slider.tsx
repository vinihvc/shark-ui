...
export const Slider = (props: SliderProps) => {
  ...
  return (
    ...
    >
          ...
          return (
            <ArkSlider.Thumb
              className={cn(
                ...
                "size-4.5",
                "bg-white",
                "rounded-full border shadow-sm ring-ring/50",
                "cursor-grab select-none",
                "transition-[color,box-shadow,transform]",
                "hover:ring-[3px]",
                "focus-visible:outline-hidden focus-visible:ring-4",
                "origin-left data-dragging:scale-110 data-dragging:cursor-grabbing data-dragging:ring-[3px]",
      ...
      {showMarkers && (
        <ArkSlider.MarkerGroup className="mt-3 flex w-full items-center justify-between gap-1 px-2.5 font-medium text-muted-foreground text-xs data-[orientation=vertical]:hidden">
