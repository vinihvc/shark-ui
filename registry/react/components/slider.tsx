					...
					return (
						<ArkSlider.Thumb
							className={cn(
								...
								"focus-visible:outline-hidden focus-visible:ring-[3px] focus-visible:border-primary focus-visible:ring-ring/32",
								"origin-left data-dragging:scale-110 data-dragging:cursor-grabbing data-dragging:ring-[3px] data-dragging:ring-ring/32 data-dragging:border-primary",
