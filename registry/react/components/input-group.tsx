...
export const InputGroup = (props: React.ComponentProps<typeof ark.div>) => {
  ...
  return (
    <ark.div
      className={cn(
        "group/input-group relative flex w-full items-center rounded-md border border-input shadow-xs outline-none transition-[color,box-shadow] dark:bg-input/20",
