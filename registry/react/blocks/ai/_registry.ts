...
export const aiBlocks = [
  {
    ...
    description:
      "Functional chat panel with a scripted simulator, empty state, thread, and composer.",
    files: [
      {
    ...
    registryDependencies: [
      ...
      absoluteUrl("/r/code-block.json"),
      absoluteUrl("/r/context.json"),
      absoluteUrl("/r/diff.json"),
      absoluteUrl("/r/file-upload.json"),
      absoluteUrl("/r/icon-tile.json"),
      absoluteUrl("/r/marker.json"),
      absoluteUrl("/r/message.json"),
      absoluteUrl("/r/message-bubble.json"),
      ...
      absoluteUrl("/r/terminal.json"),
      absoluteUrl("/r/tool-result.json"),
      absoluteUrl("/r/chat-simulator.json"),
    ],
    title: "AI Chat",
    type: "registry:block",
  },
