...
import { nativeSelectVariants } from "@/registry/solid/components/native-select";

export const parseDate = arkParseDate;

export const Calendar = (props: ComponentProps<typeof ArkCalendar.Root>) => {
  const { lazyMount = true, unmountOnExit = true, className, ...rest } = props;

  return (
    <ArkCalendar.Root
      class={cn("[--cell-size:--spacing(8)]", "w-fit", className)}
      data-slot="calendar"
      inline
      lazyMount={lazyMount}
...
export const CalendarControl = (
  props: ComponentProps<typeof ArkCalendar.Control>
) => (
  <ArkCalendar.Control
...
export const CalendarLabel = (
  props: ComponentProps<typeof ArkCalendar.Label>
) => (
  <ArkCalendar.Label
...
export const CalendarTrigger = (
  props: ComponentProps<typeof ArkCalendar.Trigger>
) => {
  return <ArkCalendar.Trigger data-slot="calendar-trigger" {...props} />;
};

export const CalendarPresetTrigger = (
  props: ComponentProps<typeof ArkCalendar.PresetTrigger>
) => {
...
export const CalendarViewDate = (
  props: ComponentProps<typeof ArkCalendar.RangeText>
) => {
  const { class: className, ...rest } = props;
...
export const CalendarTodayTrigger = (props: ComponentProps<typeof Button>) => {
...
export const CalendarClearTrigger = (
  props: ComponentProps<typeof ArkCalendar.ClearTrigger>
) => {
  const { class: className, ...rest } = props;
...
export const CalendarYearSelect = (
  props: ComponentProps<typeof ArkCalendar.YearSelect>
) => {
  const { class: className, ...rest } = props;

  return (
    <div
      class={cn("relative w-fit has-[select:disabled]:opacity-64")}
      data-slot="calendar-year-select-wrapper"
    >
      <ArkCalendar.YearSelect
        class={cn(nativeSelectVariants())}
...
export const CalendarMonthSelect = (
  props: ComponentProps<typeof ArkCalendar.MonthSelect>
) => {
  const { class: className, ...rest } = props;
  ...
  return (
    ...
    >
      <ArkCalendar.MonthSelect
        class={cn(nativeSelectVariants(), className)}
        data-slot="calendar-year-select"
        {...rest}
      />
      <ChevronDownIcon
...
export const CalendarView = (
  props: ComponentProps<typeof ArkCalendar.View>
) => {
  const { class: className, ...rest } = props;
...
export const CalendarContext = (
  props: ComponentProps<typeof ArkCalendar.Context>
) => <ArkCalendar.Context data-slot="calendar-context" {...props} />;

export const CalendarViewControl = (
  props: ComponentProps<typeof ArkCalendar.ViewControl>
) => {
  const { class: className, ...rest } = props;
...
export const CalendarPrevTrigger = (
  props: ComponentProps<typeof ArkCalendar.PrevTrigger>
) => {
  return (
    <ArkCalendar.PrevTrigger
      ...
      {...props}
    >
      <Button class="me-auto" size="icon-md" variant="ghost">
        <ChevronLeftIcon aria-hidden class="rtl:rotate-180" />
      </Button>
    </ArkCalendar.PrevTrigger>
  );
};
...
export const CalendarNextTrigger = (
  props: ComponentProps<typeof ArkCalendar.NextTrigger>
) => {
  return (
    <ArkCalendar.NextTrigger
      ...
      {...props}
    >
      <Button class="ms-auto" size="icon-md" variant="ghost">
        <ChevronRightIcon aria-hidden class="rtl:rotate-180" />
      </Button>
    </ArkCalendar.NextTrigger>
  );
};
...
export const CalendarTable = (
  props: ComponentProps<typeof ArkCalendar.Table>
) => {
  const { class: className, ...rest } = props;

  return (
    <ArkCalendar.Table
      class={cn("group", "w-full min-w-60", "border-collapse", className)}
...
interface CalendarWeekDaysProps
  extends ComponentProps<typeof ArkCalendar.TableHead> {
  /**
...
export const CalendarTableDays = (
  props: ComponentProps<typeof CalendarTableBody>
) => {
...
interface CalendarTableNextMonthProps
  extends ComponentProps<typeof CalendarTableBody> {
  /**
...
export const CalendarTableHead = (
  props: ComponentProps<typeof ArkCalendar.TableHead>
) => <ArkCalendar.TableHead data-slot="calendar-table-head" {...props} />;

export const CalendarTableRow = (
  props: ComponentProps<typeof ArkCalendar.TableRow>
) => {
  const { class: className, ...rest } = props;
  return (
    <ArkCalendar.TableRow
      class={cn("mt-1 flex w-full", className)}
...
export const CalendarTableHeader = (
  props: ComponentProps<typeof ArkCalendar.TableHeader>
) => {
  const { class: className, ...rest } = props;
...
export const CalendarTableBody = (
  props: ComponentProps<typeof ArkCalendar.TableBody>
) => {
  return <ArkCalendar.TableBody data-slot="calendar-table-body" {...props} />;
};

export const CalendarTableCell = (
  props: ComponentProps<typeof ArkCalendar.TableCell>
) => {
