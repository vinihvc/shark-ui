...
import { CheckIcon, Pipette } from "lucide-solid";
...
export const ColorPicker = (props: ColorPickerProps) => {
  ...
  return (
    <ArkColorPicker.Root
      class={cn("group/color-picker", "w-fit", "flex gap-2", className)}
...
export const ColorPickerView = (
  ...
  return (
    <ArkColorPicker.View
      class={cn("relative flex size-full flex-1 flex-col gap-4", className)}
...
interface ColorPickerEyeDropperTrigger
  extends ComponentProps<typeof ArkColorPicker.EyeDropperTrigger>,
    ButtonProps {}
...
interface ColorPickerAreaProps
  extends ComponentProps<typeof ArkColorPicker.Area> {
  /**
   *
   */
  showDots?: boolean;
...
export const ColorPickerArea = (props: ColorPickerAreaProps) => {
  const { class: className, showDots = false, children, ...rest } = props;
...
export const ColorPickerInput = (
  props: Partial<ComponentProps<typeof ArkColorPicker.ChannelInput>>
) => {
