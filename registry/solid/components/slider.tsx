import { Slider as ArkSlider, useSliderContext } from "@ark-ui/solid/slider";
...
interface SliderProps extends ComponentProps<typeof ArkSlider.Root> {
  /**
        ...
        >
          {Array.from({ length: max + 1 }, (_, index) => (
            ...
            >
              ...
              <span class={cn("group-data-interval/marker:opacity-0")}>
...
export const SliderLabel = (props: ComponentProps<typeof FieldLabel>) => {
