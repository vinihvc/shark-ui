...
import { checkboxVariants } from "@/registry/solid/components/checkbox";
...
export const TreeViewLabel = (
  ...
  return (
    <ArkTreeView.Label
      class={cn("select-none font-medium text-foreground text-sm", className)}
...
interface TreeViewBranchItemProps
  extends ComponentProps<typeof ArkTreeView.BranchControl>,
...
export const TreeViewBranchItem = (props: TreeViewBranchItemProps) => {
  ...
  return (
    <ArkTreeView.BranchControl
      class={cn(treeViewControlVariants(), className)}
...
interface TreeViewBranchTitleProps
  extends ComponentProps<typeof ArkTreeView.BranchText> {
  /**
...
interface TreeViewItemProps extends ComponentProps<typeof TreeViewItemTitle> {
  /**
   * Custom file icon
   *
   * @default <FileIcon />
...
const TreeViewItemIcon = (props: ComponentProps<typeof ark.span>) => {
  const { class: className, ...rest } = props;
...
const TreeViewItemTitle = (
  props: ComponentProps<typeof ArkTreeView.ItemText>
) => {
  const { class: className, ...rest } = props;
...
export const TreeViewCheckbox = (
  ...
  return (
    <ArkTreeView.NodeCheckbox
      class={cn(checkboxVariants(), "[&_svg]:size-3!", className)}
