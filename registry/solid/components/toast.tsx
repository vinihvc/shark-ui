...
import { Spinner } from "@/registry/solid/components/spinner";
...
export const ToastItem = (props: ToastItemProps) => {
  ...
  return (
    <ArkToast.Root
      class={cn(toastVariants(), className)}
      data-slot="toast"
    ...
    >
      <div class="flex items-start gap-1.5">
        ...
        <div class="flex flex-col gap-0.5">
          <ArkToast.Title class="font-medium text-sm" data-slot="toast-title">
            {toastData.title}
          </ArkToast.Title>
      ...
      <div class="flex items-center gap-2">
        ...
        {toastData.closable && (
          <ArkToast.CloseTrigger asChild data-slot="toast-close-trigger">
            <Button
              aria-label="Close"
              class="opacity-64 hover:opacity-100"
              size="icon-xs"
              variant="ghost"
            >
              <XIcon />
