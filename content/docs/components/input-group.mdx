---
title: Input Group
description: Group input elements together.
---
...
<Step>This component depends on [Input](/docs/components/input), [Button](/docs/components/button), and [Textarea](/docs/components/textarea). Install them first if you haven't already.</Step>
