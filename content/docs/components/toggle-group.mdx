...
<Step>This component depends on [Toggle](/docs/components/toggle). Install them first if you haven't already.</Step>
...
The `pill` prop creates fully rounded toggle groups. With `spacing={0}`, the group becomes a segmented pill control. With spacing, each item is individually pill-shaped.

<ComponentPreview componentName="toggle-group" fileName="example-pill" />
