...
Root container for the image cropper. Renders a `div`.
...
The image element to crop. Renders an `img`.
...
The crop selection overlay with handles and grid. Renders a `div`.
