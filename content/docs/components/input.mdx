...
<ComponentPreview componentName="input" fileName="size-xs" />

### Small

<ComponentPreview componentName="input" fileName="size-sm" />

### Large

<ComponentPreview componentName="input" fileName="size-lg" />

### Extra Large

<ComponentPreview componentName="input" fileName="size-xl" />
...
You can also use the <Link href="/docs/components/file-upload">`<FileUpload />`</Link> component to upload files.
