...
seoDescription: "Build responsive React sidebars with Shark UI, including navigation groups, collapsible rails, mobile sheets, keyboard shortcuts, and accessible app structure."
links:
