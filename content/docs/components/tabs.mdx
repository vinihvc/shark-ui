---
title: Tabs
description: A tabs for navigating between content.
links:
...
The `pill` prop on `TabsList` creates fully rounded tabs. Only applies when `variant` is `"default"`.

<ComponentPreview componentName="tabs" fileName="example-pill" />
