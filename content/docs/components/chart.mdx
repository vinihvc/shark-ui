...
<Step>Import the following chart color variables into your CSS file (if they are not already in your theme)</Step>
...
Shark's chart helpers wrap Recharts with `ChartContainer`, tooltip, and legend, styled with Shark tokens. The layout matches [shadcn/ui charts](https://ui.shadcn.com/docs/components/base/chart).
