---
title: LLMs.txt
description: Let AI assistants use the compact Shark UI documentation index.
---

Shark UI provides a compact [LLMs.txt](https://llmstxt.org/) index so AI coding assistants can discover the documentation without crawling the full site. Public documentation is available to search and user-requested fetchers; model-training crawlers remain restricted.
