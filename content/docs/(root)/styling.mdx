...
The theme preset provides font tokens with system fallbacks. Use `--font-sans` for body text, `--font-heading` with `font-heading` for headings, and `--font-mono` for code. Define these variables with any font tooling you use.
