...
All the colors uses predefined colors from [Tailwind CSS](https://tailwindcss.com/docs/colors) and set on the `globals.css` file. It follows the color naming convention from shadcn/ui .
