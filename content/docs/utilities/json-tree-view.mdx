...
Customize how specific values are rendered using the `renderValue` prop. This example makes email addresses clickable.

<ComponentPreview componentName="json-tree-view" fileName="example-custom-render" />
