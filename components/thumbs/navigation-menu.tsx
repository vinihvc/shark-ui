...
export const NavigationMenuThumb = (props: BlockThumbCardProps) => (
  <BlockThumbCard {...props}>
    <div className="flex w-52 flex-col gap-3">
      <div className="flex items-center gap-2 rounded-lg border bg-muted p-1.5 shadow-md/5">
        <div className="h-2 w-12 rounded bg-muted-foreground/24" />
        <div className="h-2 w-10 rounded-full bg-muted-foreground/8" />
        <div className="h-2 w-8 rounded-full bg-muted-foreground/8" />
      </div>
      <div className="flex flex-col gap-1 rounded-lg border bg-popover p-2 shadow-md/5">
