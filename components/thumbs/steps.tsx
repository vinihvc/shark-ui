...
export const StepsThumb = (props: ThumbCardProps) => (
  <ThumbCard {...props}>
    <div className="flex items-center gap-1 rounded-lg border border-input bg-muted p-3 shadow-md/5">
      <div className="size-5 rounded-full border-2 border-primary border-input bg-primary" />
      ...
      <div className="size-5 rounded-full border-2 border-muted-foreground/16 border-input" />
    </div>
  </ThumbCard>
);
