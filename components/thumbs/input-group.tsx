...
export const InputGroupThumb = (props: ThumbCardProps) => (
  <ThumbCard {...props}>
    <div className="flex overflow-hidden rounded-lg border border-input bg-muted shadow-md/5">
      <div className="flex size-8 shrink-0 items-center justify-center border-border border-r border-input">
      ...
      <div className="flex size-8 shrink-0 items-center justify-center border-border border-l border-input">
