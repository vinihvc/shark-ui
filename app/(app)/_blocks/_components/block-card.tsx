...
export const BlockCard = (props: BlockCardProps) => {
  ...
  return (
    <ark.div
      ...
      {...rest}
    >
      <div className="relative z-20 flex shrink-0 items-center justify-end gap-2 px-3 py-2">
      ...
      <div className="relative flex min-h-50 min-w-0 flex-1 flex-col flex-wrap items-center justify-center overflow-hidden rounded-2xl border border-input">
        <iframe
