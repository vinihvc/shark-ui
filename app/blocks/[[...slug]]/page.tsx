...
import { blocksSource, getBlocksPageImage } from "@/lib/source";
import { getMDXComponents } from "@/mdx-components";

export const generateStaticParams = () => blocksSource.generateParams();

export const generateMetadata = async (
  props: PageProps<"/blocks/[[...slug]]">
): Promise<Metadata> => {
  ...
  return {
    ...
    openGraph: {
      images: getBlocksPageImage(page).url,
    },
  };
};

const BlocksPage = async (props: PageProps<"/blocks/[[...slug]]">) => {
  const params = await props.params;
  const page = blocksSource.getPage(params.slug);
